...
const imgBlockOld = `                    <div className="md:order-2 relative flex justify-center md:justify-end min-w-0 w-full">
...
const imgBlockNew = `                    <div className="md:order-2 relative flex justify-center md:justify-end min-w-0 w-full">
                        ...
                        <div className="flex gap-4 overflow-x-auto hide-scrollbar w-full snap-x snap-mandatory pb-4 md:pb-0 md:grid md:grid-cols-2 md:gap-4 md:w-auto md:max-w-[480px]">
                            <img draggable={false}
                                src={detailsImage}
                                alt="Fashion detail 1"
