...
export default function ThumbnailCarousel({ initialIndex = 0 }: { initialIndex?: number }) {
  ...
  return (
    <div className='w-full max-w-3xl mx-auto px-12 md:px-0 pointer-events-none'>
      <div className='flex flex-col gap-3 pointer-events-auto'>
        {/* Main Carousel */}
        <div className='relative'>
          <div className='overflow-hidden rounded-lg bg-gray-100' ref={containerRef}>
            <motion.div
              className='flex'
              drag='x'
              dragElastic={0.2}
          ...
          <motion.button
            ...
            className={`absolute -left-16 md:-left-20 text-white/70 hover:text-white top-1/2 -translate-y-1/2 flex items-center justify-center transition-transform z-10 p-2
              ${
                index === 0
          ...
          <motion.button
            ...
            className={`absolute -right-16 md:-right-20 text-white/70 hover:text-white top-1/2 -translate-y-1/2 flex items-center justify-center transition-transform z-10 p-2
              ${
